...
function Project() {
    ...
    useEffect(() => {
        const info = foundProject(projects);
        setProject(info);
    }, [id]);

    const { Image, Title, Description, Url, Technologies, Github, Features } = project;
    ...
    return (
        <section className="project-section">
            <div className="back-home-container">
                <Link to="/#Projects" className="back-home-btn" onClick={handleBack}>
                    Back
                </Link>
                <span>Projects</span>
                <span>&gt;</span>
            ...
            <div className="project-information-container">
                <div className="project-information">
                    ...
                    <hr></hr>
                    <p>{Description}</p>
                    <div className="project-more-information">
